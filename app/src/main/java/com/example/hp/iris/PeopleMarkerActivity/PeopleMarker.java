...
//        char a=s.charAt(0);
          ...
          if(cv.equals("2")){
              ...
              System.out.println("bow"+ ImagePathAdapter.getName()+ImagePathAdapter.getRelation());
...
//        }
    ...
    public class Image_Upload_S3 extends AsyncTask<String, Integer, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            System.out.println("bow"+key + "    "+ImagePathAdapter.path);
            ...
            transferObserver.setTransferListener(new TransferListener() {
                ...
                public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
                    System.out.println("Proces :"+bytesCurrent + "  "+ bytesTotal);

                    int percentage = (int) (bytesCurrent/bytesTotal)*100;
                    System.out.println(" onProgressChanged "+percentage);

                    if(percentage == 100){
                        startActivity(new Intent(PeopleMarker.this, BlindFit.class));
                    }
